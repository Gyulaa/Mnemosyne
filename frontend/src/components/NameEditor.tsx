...
const INPUT_CLS = 'w-full bg-zinc-800 border border-zinc-700 rounded px-2 py-1 text-xs text-zinc-100 placeholder-zinc-600 outline-none focus:border-brand-400'
const LABEL_CLS = 'text-[10px] text-zinc-500 block mb-0.5'
  ...
  return (
    <div className="space-y-1.5">
      <div className="grid grid-cols-2 gap-1.5">
        ...
        <div>
          <label className={LABEL_CLS}>Middle name(s)</label>
          <input
      ...
      <div>
        <label className={LABEL_CLS}>Title / Suffix</label>
        <input
